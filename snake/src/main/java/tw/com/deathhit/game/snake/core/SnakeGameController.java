...
public abstract class SnakeGameController extends Handler implements Runnable{
    ...
    public SnakeGameController(@NonNull SnakeGameModel model, @NonNull Looper looper, @Nullable Handler.Callback callback) {
    ...
    public MapObject getNextObject(){
        return model.getMap().get(getNextX(), getNextY());
    }
    ...
    public int getNextY(){
        int height = model.getMap().getWidth();
